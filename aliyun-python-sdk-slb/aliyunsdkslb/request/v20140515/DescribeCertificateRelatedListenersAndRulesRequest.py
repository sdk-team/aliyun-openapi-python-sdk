...
class DescribeCertificateRelatedListenersAndRulesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Slb', '2014-05-15', 'DescribeCertificateRelatedListenersAndRules','asdfdsf')
