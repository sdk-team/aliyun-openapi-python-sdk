...
class ModifyImageShareGroupPermission_GatedLaunchRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Ecs', '2014-05-26', 'ModifyImageShareGroupPermission_GatedLaunch','ecs')
