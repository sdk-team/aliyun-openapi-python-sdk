...
class DescribePriceRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Ecs', '2016-03-14', 'DescribePrice','ecs')
	...
	def get_NeedSpotPrice(self):
		return self.get_query_params().get('NeedSpotPrice')

	def set_NeedSpotPrice(self,NeedSpotPrice):
		self.add_query_param('NeedSpotPrice',NeedSpotPrice)
