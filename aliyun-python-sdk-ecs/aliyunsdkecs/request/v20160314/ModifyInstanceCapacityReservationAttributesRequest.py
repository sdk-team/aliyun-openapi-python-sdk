...
class ModifyInstanceCapacityReservationAttributesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Ecs', '2016-03-14', 'ModifyInstanceCapacityReservationAttributes','ecs')
