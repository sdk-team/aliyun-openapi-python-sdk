...
class CreateOrderRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Ecs', '2016-03-14', 'CreateOrder','ecs')
	...
	def get_AsyncPattern(self):
		return self.get_query_params().get('AsyncPattern')

	def set_AsyncPattern(self,AsyncPattern):
		self.add_query_param('AsyncPattern',AsyncPattern)
