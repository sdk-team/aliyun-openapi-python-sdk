...
class PutVersionDocumentRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'PutVersionDocument')
		self.set_uri_pattern('/VersionDocument/[ProductName]/[VersionName]/[Language]/[Site]')
		self.set_method('PUT')
