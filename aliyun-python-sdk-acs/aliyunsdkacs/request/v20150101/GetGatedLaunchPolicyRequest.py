...
class GetGatedLaunchPolicyRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'GetGatedLaunchPolicy')
		self.set_uri_pattern('/GatedLaunchPolicy/[ProductName]/[PolicyName]')
		self.set_method('GET')
