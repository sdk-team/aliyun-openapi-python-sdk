...
class ReleaseApiDocRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'ReleaseApiDoc')
		self.set_uri_pattern('/ReleaseApiDoc/[ProductName]/[VersionName]/[ApiName]/[Language]')
		self.set_method('PUT')
