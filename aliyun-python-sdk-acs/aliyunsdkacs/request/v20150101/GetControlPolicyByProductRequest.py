...
class GetControlPolicyByProductRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'GetControlPolicyByProduct')
		self.set_uri_pattern('/ControlPolicy/[Product]')
		self.set_method('GET')
