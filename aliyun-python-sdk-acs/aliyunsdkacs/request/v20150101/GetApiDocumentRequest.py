...
class GetApiDocumentRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'GetApiDocument')
		self.set_uri_pattern('/ApiDocument/[ProductName]/[VersionName]/[ApiName]/[Language]/[Site]/[IsDraft]')
		self.set_method('GET')
