...
class PutVersionDocRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'PutVersionDoc')
		self.set_uri_pattern('/VersionDoc/[ProductName]/[VersionName]/[Language]')
		self.set_method('PUT')
