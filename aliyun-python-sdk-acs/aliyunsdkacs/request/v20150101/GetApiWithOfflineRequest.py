...
class GetApiWithOfflineRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'GetApiWithOffline')
		self.set_uri_pattern('/ApiWithOffline/[ProductName]/[VersionName]/[ApiName]')
		self.set_method('GET')
