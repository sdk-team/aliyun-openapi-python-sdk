...
class PutProductDocumentRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'PutProductDocument')
		self.set_uri_pattern('/ProductDocument/[ProductName]/[Language]/[Site]')
		self.set_method('PUT')
