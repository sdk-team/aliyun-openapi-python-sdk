...
class GetFlowSpecialByProductRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'GetFlowSpecialByProduct')
		self.set_uri_pattern('/FlowSpecial/[Product]')
		self.set_method('GET')
