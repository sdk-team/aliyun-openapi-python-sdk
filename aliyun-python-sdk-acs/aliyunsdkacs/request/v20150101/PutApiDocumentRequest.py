...
class PutApiDocumentRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'PutApiDocument')
		self.set_uri_pattern('/ApiDocument/[ProductName]/[VersionName]/[ApiName]/[Language]/[Site]')
		self.set_method('PUT')
