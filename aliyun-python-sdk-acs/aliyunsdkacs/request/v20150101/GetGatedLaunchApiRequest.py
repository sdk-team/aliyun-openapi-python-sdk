...
class GetGatedLaunchApiRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'GetGatedLaunchApi')
		self.set_uri_pattern('/GatedLaunch/[ProductName]/[VersionName]/[ApiName]')
		self.set_method('GET')
