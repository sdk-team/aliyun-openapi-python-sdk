...
class GetApiDocNewRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'GetApiDocNew')
		self.set_uri_pattern('/ApiDocNew/[ProductName]/[VersionName]/[ApiName]/[Language]/[IsDraft]')
		self.set_method('GET')
