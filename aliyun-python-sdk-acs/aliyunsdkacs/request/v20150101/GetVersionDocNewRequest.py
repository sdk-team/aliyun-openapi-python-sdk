...
class GetVersionDocNewRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'GetVersionDocNew')
		self.set_uri_pattern('/VersionDocNew/[ProductName]/[VersionName]/[Language]/[IsDraft]')
		self.set_method('GET')
